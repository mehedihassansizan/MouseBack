...
const UsersSays = () => {
  return (
    <div className="md:p-24 font-mono">
        ...
        <div class="relative sm:top-5 sm:right-5 md:h-[550px] md:w-[1180px] bg-gray-900 dark:bg-boxdark px-8 py-20 shadow-xl sm:rounded-xl sm:px-10 sm:py-16 md:px-12 lg:px-20">
